...
public class RoutePlanDemo extends AppCompatActivity implements BaiduMap.OnMapClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rout_line);
    ...
    public void searchButtonProcess(View v) {
        ...
        PlanNode stNode = PlanNode.withLocation(pt1) ;//PlanNode.withCityNameAndPlaceName("北京", startNodeStr);
        PlanNode enNode = PlanNode.withLocation(pt2)  ;//PlanNode.withCityNameAndPlaceName("北京", endNodeStr);
